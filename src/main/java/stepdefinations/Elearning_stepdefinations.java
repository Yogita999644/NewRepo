...
public class Elearning_stepdefinations {
	...
	// }
	//
	// @Then("^I entered the username \"([^\"]*)\" and password \"([^\"]*)\"$")
	// public void i_entered_the_username_and_password(String username, String
	...
	public void i_entered_the_password_for_user() throws Throwable {
		driver.findElement(By.xpath("//*[@name=\"password[password]\"]")).sendKeys("yogita");
	}
	...
	public void delete_the_user() throws Throwable {
		driver.findElement(By.xpath("//*[@name='keyword']")).sendKeys("yogi001");
